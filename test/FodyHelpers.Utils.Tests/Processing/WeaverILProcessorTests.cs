using FodyHelpers.Tests.Support;

namespace FodyHelpers.Tests.Processing;

public class WeaverILProcessorTests
{
    [Fact]
    public void ShouldSplitInstructionsIntoBasicBlocks()
    {
    ...
    [Fact]
    public void ShouldMergeBasicBlocks()
    {
        var targetA = Instruction.Create(OpCodes.Nop);
